...
#plot model and data
def plot_individual_datasets(bjd, rvs, rverrs, i, input_planet_params, input_calib_params, samples, labels, inf='', p = False, k = False, od='', bjd_limits=[], detach_calib=False) :
...
def analysis_of_residuals(bjd, rvs, rverrs, planet_params, calib_params, inf='', p = False, k = False, r = False, od='', output="") :
...
def plot_all_datasets(bjd, rvs, rverrs, input_planet_params, input_calib_params, samples, labels, inf='', p = False, k = False, od = '', dt_before=0., dt_after=0.) :
